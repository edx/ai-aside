...
"""
ai-aside documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'ai-aside',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/ai-aside",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'temporary readme filler',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'ai_aside'),
                os.path.join(root_path, 'ai_aside/migrations')])
